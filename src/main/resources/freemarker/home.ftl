<@page title="Design-a pizza &#10102; Choose your base size" activeNav="home">
<div class="container">
    <div class="hero-unit">
...
<div class="container marketing">
    <div class="row">
        ...
        <div class="span4">
            ...
            <button id="save-pizza-btn" class="btn btn-primary" type="button">Order now</button>
            <hr/>
            <h3>Toppings</h3>
...
<script type="text/javascript">
    $(function() {
        ...
        $("#save-pizza-btn").click(function() {
            var pizzaSizeId = $("#selectable-size option:selected").attr('value');
            var toppings = $("#selectable-toppings").val();
            $.ajax({
                type: "POST",
                url: "<@spring.url '/pizza/save'/>",
                traditional: true,
